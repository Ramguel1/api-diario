...
entradas = []  # almacenamiento simulado para perfil emocional

def calcular_perfil():
    if not entradas:
        return "No se han registrado entradas suficientes para generar un perfil."
